...
for (let i = 0; i < params.N; i++) {
  ...
  let node = {
    ...
    color: color,
    group: "text_spirale",
    x: params.scale * coords.x, //hyperbol_helicoid.x, //helix.x,//i,
    y: params.scale * coords.y, //hyperbol_helicoid.y, //helix.y,//i,
    z: params.scale * coords.z, //hyperbol_helicoid.z, //helix.z,//i, // fixed position
    // rotation: {}
  };
